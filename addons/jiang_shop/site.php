...
class Jiang_shopModuleSite extends WeModuleSite {

	/** 商品分类表 */
	private $tb_category = 'kt_store_category';
	
	/** 商品信息表*/
	private $tb_goods = 'kt_store_goods';
	
	/** 购物车表 */
	private $tb_cart = 'kt_store_cart';

	/** 订单表 */
	private $tb_order = 'kt_store_orders';
	
	/** 订单清单表*/
	private $tb_item = 'kt_store_items';
